...
const liveOutputs = [
  {
    ...
    name: "دانة",
    role: "المصممة",
    prompt: "توليد صورة تصميم: زجاجة عطر عود فاخرة على رخام داكن، بألوان كحلي وذهبي، ستايل مينيمال، مربع 1:1.",
  ...
  },
  {
    ...
    summary: "جهّزت 3 صيغ للمتابعة، والنسخة القصيرة هي الأنسب لطلب رد واضح بلا ضغط.\n\nاليوم: متابعة قصيرة\nبعد 3 أيام: نسخة ودّية\nبعد 7 أيام: إغلاق مهذب",
  },
  {
    id: "sam",
    name: "سالم",
    ...
    title: "رد بيع حاسم",
    summary: "أستاذ محمود، متفهم إن العرض أعلى من الميزانية المتوقعة. بدل ما نخفض السعر ونضعف النتيجة، نقدر نراجع البنود ونحتفظ بالأولوية فقط ضمن نطاق أصغر. هل الأنسب نراجع النطاق في مكالمة قصيرة، أم نغلق الملف مؤقتًا؟",
  },
  {
    id: "nour",
    name: "نور",
    ...
    summary: "تحققت الآن، لكن النتائج المتاحة لا تحدد خبراً عاماً يمكن وصفه بأنه الأهم في مصر. ولا تتضمن رقماً مؤكداً لسعر الدولار مقابل الجنيه؛ لذلك لن أذكر سعراً غير موثّق.",
  },
  {
    id: "adam",
    name: "آدم",
    ...
    summary: "القرار الآن: ثبّت ميزانيات الحملات. لم أجد بيانات إنفاق أو تحويلات تسمح بتحديد حملة رابحة.\n\nلا تحكم بسعر النقرة وحده؛ القرار النهائي يُبنى على CPA وROAS وصافي الإيراد.",
  },
] as const;
        ...
        <div className="sahl-shell">
          <Reveal>
            <header className="sahl-section-head is-split">
              ...
              <p>
                طلبات حقيقية كُتبت للموظفين داخل الحساب التجريبي، وتحت كل طلب المخرج الذي سُلّم فعلًا
                للمراجعة — بلا نشر خارجي.
              </p>
            </header>
          </Reveal>
            ...
            {liveOutputs.map((output, index) => (
              ...
              >
                ...
                <article className="sahl-live-response">
                  ...
                  {output.image ? (
                    <img src={output.image} alt="زجاجة عطر عود فاخرة على رخام داكن" loading="lazy" />
                  ) : null}
