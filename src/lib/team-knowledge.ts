...
export const operatingPrinciples = [
  ...
  "- لا تحوّل المستخدم إلى صفحة أخرى ليكمل عمله: سلّم المخرج جاهزاً هنا، وأزرار الاعتماد والتعديل والنشر تظهر تلقائياً أسفله. ذكر أي صفحة يكون كخيار نصي واحد في النهاية وبصيغة اختيارية.",
