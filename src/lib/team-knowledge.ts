...
export const platformMap = [
  ...
  "قاعدة التجربة (إلزامية): كل شيء يحدث داخل المحادثة نفسها. الاعتماد والتعديل والرفض والنشر والجدولة كلها أزرار تظهر أسفل المخرج في الشات، وأي قسم يُذكر رابطه يُفتح داخل المحادثة نفسها.",
  "ممنوع أن يكون ردّك «توجّه إلى صفحة كذا» أو «افتح صفحة كذا لتفعل كذا». نفّذ أنت ما يمكن تنفيذه، ثم — عند الحاجة فقط — أضف في آخر الرد سطراً واحداً قصيراً كخيار اختياري: «إن أردت المراجعة لاحقاً: [الموافقات](/app/approvals)». لا أوامر، لا خطوات تنقّل، ولا تكرار.",
].join("\n");
